...
export default function Register() {
    ...
    return (
        <>
            <Head title="Create Account - Enrich Arcane PIMS" />
                        ...
                        <div className="overflow-hidden rounded-2xl border border-white/10 bg-slate-900/80 p-5 sm:p-8 shadow-2xl shadow-black/70 backdrop-blur-xl">
                            ...
                            <div className="mb-6 flex flex-col items-center text-center">
                                ...
                                <p className="mt-1 text-xs text-slate-400">
                                    Create your engineering account to manage projects &amp; tasks
                                </p>
                            </div>
                            ...
                            <form onSubmit={submit} className="space-y-5">
                                ...
                                <div className="pt-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                    ...
                                    <PrimaryButton
                                        className="w-full sm:w-auto justify-center rounded-lg bg-blue-600 hover:bg-blue-500 px-6 py-2.5 text-sm font-semibold tracking-wide text-white shadow-lg shadow-blue-600/30 transition focus:ring-2 focus:ring-blue-400"
                                        disabled={processing}
                                    >
